...
lane="$1"; PIN='e85808324f51fc694d12e3ed7439552a3c3f9540'; profile="thermo_state_recovery_v03_${lane}.pre"; manifest="thermo_state_recovery_v03_${lane}_profile_manifest.json"
...
python3 verification/m21/prepare_thermo_state_cases_recovery_v03.py thermo_cases
